...
const DailySummaryReports = lazy(() => import('@/app/reports/daily-summary/page'))
...
export const routes: RouteConfig[] = [
  ...
  },
  {
    ...
    element: <ProtectedRoute menuPaths={['/reports/daily-summary']}><DailySummaryReports /></ProtectedRoute>
  },
  {
    path: "/mail",
